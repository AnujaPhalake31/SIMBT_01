...
public class tictactoe {
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btn2.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btn3.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		xCount.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btn4.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btn5.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btn6.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		lblNewLabel_1.setFont(new Font("Lato", Font.PLAIN, 25));
		...
		oCount.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btn7.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btn8.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btn9.setFont(new Font("Lato", Font.PLAIN, 99));
		...
		btnReset.setFont(new Font("Lato", Font.PLAIN, 22));
		...
		btnExit.setFont(new Font("Lato", Font.PLAIN, 25));
